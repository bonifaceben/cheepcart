...
export default function Home() {
  ...
  // ================= SIDE ROTATE =================
  useEffect(() => {
    if (!sideBanner?.mediaItems?.length)
      return;
              ...
              preOrderProducts
                ...
                .map((product) => (
                  ...
                  >
                    ...
                    <button
  className="china-order-btn"
  onClick={() =>
    navigate(
      `/china-products/${product.slug}`
    )
  }
>
  Enquire Now
